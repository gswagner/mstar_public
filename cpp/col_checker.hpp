...
namespace mstar{
  ...
  public:
    virtual ~ColChecker(){};
    virtual ColSet check_edge(const Coord &c1, const Coord &c2,
   ...
   */
    ...
    public:
       ...
       */
      ColSet check_edge(const Coord &c1, const Coord &c2,
			const std::vector<int> ids) const;
  };

  class ODColChecker{
  public:
    virtual ~ODColChecker(){};
   ...
   * for rotations
   */
    class SimpleGraphODColCheck: public ODColChecker{
    public:
      /**
       * Checks for collision while traversing the edge from c1 to c2
       *
